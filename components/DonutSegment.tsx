...
export function DonutChart({ size = 120, data }: DonutChartProps) {
    ...
    <div className="relative inline-block">
      ...
      >
        ...
        <path
          fillRule="evenodd"
          clipRule="evenodd"
          d="M17.012 18.3464C16.3669 18.7927 15.7633 19.3216 15.2167 19.9324C10.6472 25.0377 6.93133 30.94 4.30199 37.4135C2.18591 42.6234 4.67475 48.57 9.86095 50.6957C15.0472 52.8215 20.9668 50.3213 23.0829 45.1114C24.8159 40.8447 27.2707 36.941 30.3003 33.5562C30.352 33.4984 30.403 33.4401 30.4532 33.3814C26.2304 33.1582 22.1505 31.0505 19.5439 27.2966C17.6539 24.5746 16.8401 21.4214 17.012 18.3464Z"
          fill={data[3].color}
          className="cursor-pointer transition-opacity hover:opacity-80"
